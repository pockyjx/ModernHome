...
public class EmployeeVO {
	...
	private Timestamp emp_rsgnt_date;
	...
	public Timestamp getEmp_rsgnt_date() {
		return emp_rsgnt_date;
	}
	public void setEmp_rsgnt_date(Timestamp emp_rsgnt_date) {
		this.emp_rsgnt_date = emp_rsgnt_date;
	}
	public Timestamp getEmp_start_leave_date() {
		return emp_start_leave_date;
	}
	public void setEmp_start_leave_date(Timestamp emp_start_leave_date) {
		this.emp_start_leave_date = emp_start_leave_date;
	}
	public Timestamp getEmp_end_leave_date() {
		return emp_end_leave_date;
	}
	public void setEmp_end_leave_date(Timestamp emp_end_leave_date) {
