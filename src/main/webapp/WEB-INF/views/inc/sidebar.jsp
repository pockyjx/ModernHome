...
<!--                         <img class="rounded-circle" src="/resources/img/user.jpg" alt="" style="width: 40px; height: 40px;"> -->
						<a href="/"><img src="/resources/img/logo.svg" width="200px"><br><br></a>
...
<!--                     </div> -->
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
					 	...
					 	<div class="dropdown-menu bg-transparent border-0">
                           <a href="/production/quality/materialQualityList" class="dropdown-item">ㄴ<i class=" me-2"></i>수입검사</a>
                           <a href="/production/quality/qualitylist" class="dropdown-item">ㄴ<i class=" me-2"></i>공정검사</a>
                           <a href="/production/quality/factoryInspection" class="dropdown-item">ㄴ<i class=" me-2"></i>출고검사</a>
